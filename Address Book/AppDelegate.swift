...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate 
{
  ...
  // The persistent container for this application.
  ...
  // saveContext() is called by AppDelegates applicationWillTerminate
  // method ensuring that all remaining changes are saved before this
